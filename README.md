...
- **[AgentForms](https://agentforms.dev)** – Structured human input for AI agents. A programmatic API and SDK that lets AI agents create forms, collect responses, and handle callbacks in real time.
